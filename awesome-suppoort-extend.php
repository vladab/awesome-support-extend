...
// enable editing ticket
add_filter( 'wpas_ticket_reply_controls', 'wpas_extended_ticket_reply_controls', 10, 3 );

function wpas_extended_ticket_reply_controls( $controls, $ticket_id, $reply ) {

    if ( 0 !== $ticket_id && (get_current_user_id() == $reply->post_author || current_user_can('administrator') ) ) {
